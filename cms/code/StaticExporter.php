...
class StaticExporter extends Controller {
	function init() {
		...
		$canAccess = (($_SERVER['REMOTE_ADDR'] == '178.63.91.70') || ($_SERVER['REMOTE_ADDR'] == '::1') || Director::isDev() || Director::is_cli() || Permission::check("ADMIN"));
	...
	function export() {
		...
		foreach($pages as $page) {
			...
			$response = Director::test($link,array("StaticExport" => 1),null,"GET");
